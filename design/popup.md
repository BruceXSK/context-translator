...
- 设置页（POP-006，独立 open_in_tab 页）：base URL / API key / model / 触发键 / 思考模式（开关，默认开）/ 思考强度（Low/Medium/High/Max 单选，默认 Low；思考模式关时禁用灰化）/ system prompt。
